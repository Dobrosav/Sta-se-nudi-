 ...
 */
class Chats extends \App\Models\Entities\Chats implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Models\\Entities\\Chats' . "\0" . 'idc', '' . "\0" . 'App\\Models\\Entities\\Chats' . "\0" . 'message', '' . "\0" . 'App\\Models\\Entities\\Chats' . "\0" . 'datetime', '' . "\0" . 'App\\Models\\Entities\\Chats' . "\0" . 'status', '' . "\0" . 'App\\Models\\Entities\\Chats' . "\0" . 'userTo', '' . "\0" . 'App\\Models\\Entities\\Chats' . "\0" . 'userFrom'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Chats $proxy) {
